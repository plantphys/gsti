...
wv=400:2500 ## Wavelengths used for the PLSr
...
test_LOO = plsr(sqrt_Vcmax25~ Spectra,ncomp = 25, data = Database, validation = "LOO")
res_LOO = test_LOO$validation$pred[,1,25]-Database$sqrt_Vcmax25
hist(res_LOO)
...
Database=Database[!is.na(Database$StdError_Vcmax25/Database$Vcmax25)&Database$StdError_Vcmax25/Database$Vcmax25<0.15,]
############################
#### PLSR models VCMAX25 ###
############################
...
save(file="PLSR_model_Vcmax25.Rdata",plsr_model,training,validation)
