...
QC_table=cbind.data.frame(SampleID_num=c(46,46,46,53,70,71,72,73,110,110,111,157),
                          Obs=c(16,6,7,1,1,16,1,16,16,17,1,18)) ## 
...
curated_data[curated_data$SampleID_num==52&curated_data$Obs>12,'QC']='ok'
curated_data[curated_data$SampleID_num==72&curated_data$Obs>11,'QC']='ok'
curated_data[curated_data$SampleID_num==73&curated_data$Obs>12,'QC']='ok'
curated_data[curated_data$SampleID_num==78&curated_data$Obs>12,'QC']='ok'
curated_data[curated_data$SampleID_num==79&curated_data$Obs>13,'QC']='ok'
curated_data[curated_data$SampleID_num==103&curated_data$Obs>13,'QC']='ok'
curated_data[curated_data$SampleID_num==104&curated_data$Obs>13,'QC']='ok'
curated_data[curated_data$SampleID_num==115&curated_data$Obs>11,'QC']='ok'
curated_data[curated_data$SampleID_num==125&curated_data$Obs>12,'QC']='ok'
curated_data[curated_data$SampleID_num==127&curated_data$Obs>12,'QC']='ok'
