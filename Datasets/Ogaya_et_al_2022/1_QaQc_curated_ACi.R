...
ls_done=dir(file.path(path,'/Datasets/Ogaya_et_al_2022/Curated_ACi'))
...
ls_files=dir(file.path(path,'/Datasets/Ogaya_et_al_2022/Curated_ACi'))
curated_data=data.frame()
for(file in ls_files){
  print(file)
  data_file=read.csv(file.path(path,'/Datasets/Ogaya_et_al_2022/Curated_ACi/',file))
