...
# Averaging the multiple spectra measured in the same leaves
Reflectance=aggregate(Reflectance[,4:2154],by=list(Reflectance$SampleID),FUN=mean)
...
Reflectance$Spectrometer="ASD FieldSpec 3 JR"
