...
# The authors already flagged bad data, so I re-use their classification here
curated_data[curated_data$Remove=='EXCLUDE','QC']='bad'
...
QC_table=cbind.data.frame(SampleID_num=c(12,13,12,13),
                          Record=c(8,8,16,16)) 
