...
## Estimating Vcmax from the survey data
survey=curated_data[curated_data$Method=="Survey",]
Bilan_survey=f.fit_One_Point(survey,param=f.make.param())
Bilan_survey=Bilan_survey[Bilan_survey$Vcmax25>0&Bilan_survey$Vcmax25<300,]
## Combining data
Bilan=rbind.data.frame(Bilan,Bilan_survey)
