...
## I manually remove Jmax25 estimated with few points. 
# The fitting procedure deals with bad estimations using traditional A-Ci measurements but not high density curves

ls_bad_Jmax=c(16,22,65,71,72,74,86,88,106,111,117:119,123,126,129)
Bilan[Bilan$SampleID_num%in%ls_bad_Jmax,c("Jmax25","StdError_Jmax25")]=NA
