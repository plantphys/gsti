...
Reflectance$Spectrometer="ASD QualitySpec Trek Portable Spectrometer"
...
Reflectance$Reflectance=I(as.matrix(Reflectance[,5:2155])*100)

# Plot of the reflectance data. If this doenst work, the most likely reason is that the format is not correct
f.plot.spec(Z = Reflectance$Reflectance,wv = 350:2500)

# 
Reflectance$SampleID=paste(Reflectance$Site,paste("_TR",Reflectance$Tree.ID,sep=""),paste("-B",Reflectance$Branch.ID,sep=""),Reflectance$Leaf.ID,sep="")
Reflectance$SampleID=gsub("ACI","-L",Reflectance$SampleID)
