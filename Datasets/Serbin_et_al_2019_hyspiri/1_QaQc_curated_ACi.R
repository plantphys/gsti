...
# update histograms to show cleaned data
hist(curated_data$Ci[which(curated_data$QC!='bad')])
hist(curated_data$gsw[which(curated_data$QC!='bad')])
#--------------------------------------------------------------------------------------------------#
...
# NOTE: Need to translate these species codes to Genus species x variety etc
#--------------------------------------------------------------------------------------------------#
...
bad_curve_list <- c("KARE_Plot1_PIME4_L2_GE_1_2015-06-08","KARE_Plot1_PIME4_L26_GE_1_2015-06-08",
                    ...
                    "KARE_Plot1_FICA_L10_GE_1_2015-06-06","KARE_Plot1_FICA_L2large_GE_1_2015-06-05",
                    "KARE_Plot1_FICA_L3large_GE_1_2015-06-05","KARE_Plot1_PUGR2_L10_GE_1_2015−06−07",
                    "Shafter_SOTU_Plot3_L9T_GE_1_2015-06-10","Shafter_SOTU_Plot4_L15T_GE_1_2015-06-10",
                    "Shafter_SOTU_Plot4_L25T_GE_1_2015-06-10","Shafter_SOTU_Plot4_L8T_GE_1_2015-06-10",
                    "Shafter_SOTU_Plot3_L6T_GE_1_2015-06-10","Shafter_SOTU_Plot3_L26T_GE_1_2015-06-10",
                    "Shafter_SOTU_Plot3_L17T_GE_1_2015-06-10","Shafter_SOTU_Plot2_L5T_GE_1_2015-06-10",
                    "Shafter_SOTU_Plot2_L2T_GE_1_2015-06-10","Shafter_SOTU_Plot2_L23T_GE_1_2015-06-10",
                    "Shafter_SOTU_Plot2_L22T_GE_1_2015-06-10","Shafter_SOTU_Plot2_L21T_GE_1_2015-06-10",
                    "Shafter_SOTU_Plot1_L1T_GE_1_2015-06-10","Shafter_SOTU_Plot1_L19T_GE_1_2015-06-10",
                    "Shafter_SOTU_Plot1_L18T_GE_1_2015-06-10","Kingsburg_Plot4_PRDU_L6T_GE_1_2015-06-09",
                    "Kingsburg_Plot4_PRDU_L5T_GE_1_2015-06-09","KARE_Plot1_PUGR2_L1_GE_1_2015-06-07",
                    "KARE_Plot1_FICA_L1_GE_1_2015-06-06","KARE_Plot1_FICA_L18_GE_1_2015-06-06",
                    "KARE_Plot1_FICA_L1large_GE_1_2015-06-05","KARE_Plot1_FICA_L1small_GE_1_2015-06-05",
                    "KARE_Plot1_FICA_L2small_GE_1_2015-06-05","KARE_Plot1_FICA_L3small_GE_1_2015-06-05",
                    "KARE_Plot1_FICA_L4large_GE_1_2015-06-05","KARE_Plot1_FICA_L4small_GE_1_2015-06-05",
                    "KARE_Plot1_FICA_L5large_GE_1_2015-06-05","KARE_Plot1_FICA_L9_GE_1_2015-06-06",
                    "KARE_Plot1_PIME4_L1_GE_1_2015-06-08","KARE_Plot1_PIME4_L11_GE_1_2015-06-08",
                    "KARE_Plot1_PIME4_L12_GE_1_2015-06-08","KARE_Plot1_PIME4_L14_GE_1_2015-06-08",
                    "KARE_Plot1_PIME4_L15_GE_1_2015-06-08","KARE_Plot1_PIME4_L16_GE_1_2015-06-08",
                    "KARE_Plot1_PIME4_L2_GE_2_2015-06-08","KARE_Plot1_PIME4_L3_GE_1_2015-06-08",
                    "KARE_Plot1_PIME4_L4_GE_1_2015-06-08","KARE_Plot2_FICA_L16_GE_1_2015-06-06",
                    "KARE_Plot2_FICA_L17_GE_1_2015-06-06","KARE_Plot2_FICA_L8_GE_1_2015-06-06",
...
#--------------------------------------------------------------------------------------------------#
flag <- which(as.character(curated_data$SampleID) %in% bad_curve_list)
unique(as.character(curated_data$SampleID)[flag])

sort(unique(curated_data[as.character(curated_data$SampleID) %in% as.character(bad_curve_list), 
                         'SampleID_num']))
...
#                                'SampleID_num']),cex=2,xlab='Ci',ylab='A')
  text(x=curated_data[curated_data$SampleID_num==SampleID_num,'Ci'],
       y=curated_data[curated_data$SampleID_num==SampleID_num,'A'], 
       labels=curated_data[curated_data$SampleID_num==SampleID_num,
                           'Record'],cex=0.7)
  ...
  if(any(curated_data[curated_data$SampleID_num==SampleID_num,'QC']=='bad')) {
    ...
    text(x=curated_data[curated_data$SampleID_num==SampleID_num&curated_data$QC=='bad','Ci'],
         y=curated_data[curated_data$SampleID_num==SampleID_num&curated_data$QC=='bad','A'], 
         labels=curated_data[curated_data$SampleID_num==SampleID_num&curated_data$QC=='bad',
                             'Record'],cex=0.7,col='red')
  }
}
dev.off()
#--------------------------------------------------------------------------------------------------#
