...
ag_datasets <- file.path(here(),'Datasets/Serbin_et_al_2015/LiCor_data/ag_sites/')
...
output_dir <- file.path(here(),'Datasets/Serbin_et_al_2015/LiCor_data/')
write.csv(ag_data, file = file.path(output_dir, "concatenated_ag_gasex_data.csv"), 
          row.names = F)

nonag_datasets <- file.path(here(),'Datasets/Serbin_et_al_2015/LiCor_data/non_ag_sites')
