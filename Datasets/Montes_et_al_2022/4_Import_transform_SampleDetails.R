...
SampleDetails$Site_name="Urbana" # Note that the site_name should be present in your Site.csv file
SampleDetails$Dataset_name="Montes_et_al_2022"
SampleDetails$Species="Glycine max" # Genus species
