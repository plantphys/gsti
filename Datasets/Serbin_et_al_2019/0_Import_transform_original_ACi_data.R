...
src_data_dir <- file.path("LiCor_data/ag_sites")
...
sampID <- paste0(original_data$Sample_Name, "_", original_data$Rep, "_", as.Date(as.character(original_data$Date), format = "%d/%m/%y"))
