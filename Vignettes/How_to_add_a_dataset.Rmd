...
We are usually quite hard on the quality analysis to only keep the curves where the estimation of Vcmax will be good. If we have doubts on the quality of the data we tend to remove them from the final curated data.
...
This codes produces a dataframe, called Bilan which includes the folowing column names:
