...
You can use a R code or another way to create this file. If you use a R code, we recommend to leave it within the dataset folder and to call it "3_Import_transform_sample_info.R".
...
We merge the fitted parameters, the spectra and the leaf information in the code called '4_Combine_spectra_traits.R'.
