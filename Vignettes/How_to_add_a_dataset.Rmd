...
This code calls the function f.fit_Aci() to estimate the photosynthetic parameters Vcmax<sub>25</sub>, J<sub>max25</sub>, TPU<sub>25</sub> and R<sub>day25</sub> from A-C<sub>i</sub> curve.  It produces several pdf files:
