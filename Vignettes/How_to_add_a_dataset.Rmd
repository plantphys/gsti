...
You can use the folder Lamour_et_al_2021 as a template. The code is commented and correspond to all the steps of this guide.
...
A data frame called SampleDetails has to be included with the columns listed below.
...
A code called "4_Import_transform_SampleDetails.R" should be used to create the SampleDetails dataframe.
