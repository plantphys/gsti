...
The curated A-C<sub>i</sub> data should be present in the dataset folder in a Rdata format called '1_QC_data.Rdata' which contains the A-C<sub>i</sub> data in a data.frame with at least the columns listed in the table below.
